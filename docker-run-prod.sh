...
mkdir tmp; chmod -R 777 tmp; chmod -R 777 public;
...
docker run --net="host" -v $PWD:/var/www/webapp:rw --name firmaexpress-rails-prod-i -i -t patriciojara/firmaexpress-rails:prod /bin/bash -l
